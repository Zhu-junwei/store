...
<script>
	$(function () {
		//向服务端CategoryServlet_getAllCats发起ajax请求，服务端经过处理，
		//将所有分类信息以JSON格式的数据返回，获取到返回的所有分类绑定在页面的显示分类区域
		var url = "/store/CategoryServlet" ;
		var obj = {"method":"findAllCats"};
		$.post(url,obj,function(data){
			$.each(data,function(i,obj){
				var li="<li><a href='${pageContext.request.contextPath}/ProductServlet?method=findProductByCidWithPage&num=1&cid="+obj.cid+"'>"+obj.cname+"</a></li>";
				$("#myUL").append(li);
			});
		},"json");
	});
